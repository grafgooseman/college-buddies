      ...
      <Box className="mt-5 md:flex">
        <Box className="relative">
          ...
          <Box className="absolute inset-0 md:hidden flex flex-col justify-center sm:mb-16">
            <Typography variant="h3" className="w-8/12 text-2xl sm:text-3xl">
              Find <span className="text-accent">meaningfull</span> connections
            </Typography>
            <Typography variant="subtitle1" className="w-7/12 sm:text-base text-xs">
